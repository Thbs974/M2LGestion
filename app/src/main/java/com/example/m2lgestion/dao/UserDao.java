...
public class UserDao {
    ...
    public static User findUserById(int userId) {
        ...
        Cursor cursor = db.query("User", null, "id=?", new
                String[]{String.valueOf(userId)}, null, null, null);
        User user = null;
        if (cursor.moveToFirst()) {
            ...
            user.setPrenom(cursor.getString(cursor.getColumnIndex("pre-nom")));
    ...
    public int updateUser(User user) {
        ...
        values.put("prenom", user.getPrenom());
        values.put("roleId", user.getRole().getId());
        int rowsAffected = db.update("User", values, "id=?", new
...
"prenom", "roleId"};
        ...
        Cursor cursor = db.query("User", null, "email=? AND password=?",
